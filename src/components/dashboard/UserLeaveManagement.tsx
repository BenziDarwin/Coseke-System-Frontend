...
const lt = [
  ...
  <Box>
    <Grid container spacing={2} marginBottom="10px">
      ...
      height={400}
      series={[
        { data: pData , id: 'pvId', label:"Leave per month" }
      ]}
...
/>
    ...
    <Grid container spacing={2}>
      <Grid item xs={6}>
      <Typography variant="h4" marginY={"10px"}>Users on Leave</Typography>
        <FolderList list={lt} />
      
      </Grid>
      <Grid item xs={6}>
      <Typography variant="h4" marginY={"10px"}>Pending Leave Requests</Typography>
          <FolderList list={lt} />   
